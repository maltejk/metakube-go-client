...
/* DeleteNodeDeploymentRequestParams contains all the parameters to send to the API endpoint
   for the delete node deployment request operation.
...
// WithDefaults hydrates default values in the delete node deployment request params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteNodeDeploymentRequestParams) WithDefaults() *DeleteNodeDeploymentRequestParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete node deployment request params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteNodeDeploymentRequestParams) SetDefaults() {
