...
type ClientService interface {
	...
	ListOpenstackQuotaLimitsNoCredentials(params *ListOpenstackQuotaLimitsNoCredentialsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListOpenstackQuotaLimitsNoCredentialsOK, error)
...
*/
func (a *Client) ListOpenstackQuotaLimitsNoCredentials(params *ListOpenstackQuotaLimitsNoCredentialsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListOpenstackQuotaLimitsNoCredentialsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
