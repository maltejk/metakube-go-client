...
/* ListOpenstackQuotaLimitsNoCredentialsParams contains all the parameters to send to the API endpoint
   for the list openstack quota limits no credentials operation.
...
// WithDefaults hydrates default values in the list openstack quota limits no credentials params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListOpenstackQuotaLimitsNoCredentialsParams) WithDefaults() *ListOpenstackQuotaLimitsNoCredentialsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list openstack quota limits no credentials params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListOpenstackQuotaLimitsNoCredentialsParams) SetDefaults() {
